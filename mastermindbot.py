...
class MastermindBot:
    ...
    def __init__(self, code_length, digit_range):
        ...
        Initialize the game with code length and digit range
            ...
            """
        self.possible_codes = list(product(range(digit_range), repeat=code_length))
    ...
    def filter_possible_guesses(self, guess, feedback):
        ...
        Parse through and keep only possible guesses
            ...
            Args:
                ...
                feeedback(tuple(int)) = a tuple of integers where the first index is "Correct Positons" and second index is "Right Number, Wrong Positon"

            Returns:
                List[list] = a list of all remaining possible codes ex: "[[1,2,3,4],[5,6,7,0]]"
